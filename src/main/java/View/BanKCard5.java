 ...
 * @author 20386
 */
public class BanKCard5 extends JPanel {
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            button3.setBackground(Color.MAGENTA); // 设置背景颜色为黄色
    ...
    protected void paintComponent(Graphics g){
        ...
        ImageIcon image2 =new ImageIcon("src/main/imgs/SmallBankCard1.png");
        g.drawImage(image.getImage(), 0,0,this.getWidth(),this.getHeight(),this);
        int image2Width = image2.getIconWidth();
        int image2Height = image2.getIconHeight();
        g.drawImage(image2.getImage(), 60, 240, image2Width,image2Height,this);
    }
